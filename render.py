...
def render_set(model_path, name, iteration, views, gaussians, pipeline, background, cam_type):
    ...
    for idx, view in enumerate(tqdm(views, desc="Rendering progress")):
        ...
        rendering = render(view, gaussians, pipeline, background,cam_type=cam_type, flag="4d")["render"]
...
def render_sets(dataset : ModelParams, hyperparam, iteration : int, pipeline : PipelineParams, skip_train : bool, skip_test : bool, skip_video: bool):
    with torch.no_grad():
        ...
        if not skip_video:
            # print("the number of getVideoCameras: ", len(scene.getVideoCameras()))
...
if __name__ == "__main__":
    ...
    # print("skip_video: ", args.skip_video)
    if args.configs:
        import mmcv
